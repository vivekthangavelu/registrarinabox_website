        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            <h1 className="text-balance text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl dark:text-white">
              Building the Future of Domain Registration from India
            </h1>
            <p className="mt-8 text-pretty text-lg font-medium text-gray-500 sm:text-xl/8 dark:text-gray-400">
              DotMonk is a next-generation gTLD registry operator committed to
              technical excellence, DNS security, and responsible stewardship of
              the internet's namespace infrastructure.
            </p>
          ...
          <figure className="grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
            <div className="relative col-span-2 lg:col-start-1 lg:row-start-2">
              ...
              <blockquote className="text-xl/8 font-semibold text-gray-900 sm:text-2xl/9 dark:text-white">
                <p>
                  The internet's future should be shaped by voices from every
                  corner of the globe.
                  <br />
                  <br />
                  DotMonk represents a simple truth: developing economies like
                  India deserve equal standing in managing the internet's
                  infrastructure.
                </p>
              </blockquote>
            </div>
            <div className="col-end-1 w-16 lg:row-span-4 lg:w-72">
              <img
                src="https://dotmonk.in/poonamshoor.png"
                alt=""
          ...
          <div className="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
            <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
              ...
              <p className="mt-6 text-lg/8 text-gray-600 dark:text-gray-400">
                We welcome inquiries from potential partners, stakeholders, and
                the global internet community. Whether you have questions about
                our registry operations, technical infrastructure, or our
                commitment to internet governance, our team is ready to engage
              ...
              <dl className="mt-10 space-y-4 text-base/7 text-gray-600 dark:text-gray-300">
                <div className="flex gap-x-4">
                  ...
                  <dd>
                    ...
                    WeWork 247 Park
                    <br />
                    13th Floor, Vikhroli Corporate Park
                    <br />
